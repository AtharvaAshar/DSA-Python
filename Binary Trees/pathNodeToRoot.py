...
def pathNodeToRoot(root, k):
    ...
    if root.data == k:
        ...
        l.append(root.data)
        return l
    leftOutput = pathNodeToRoot(root.left, k)
    if leftOutput!=None:
        leftOutput.append(root.data)
        return leftOutput
    rightOutput = pathNodeToRoot(root.right, k)
    if rightOutput!=None:
...
root = treeInput()
k=int(input("Enter node to search"))
levelOrderTraversal(root)
print()
print(pathNodeToRoot(root,k,l))
